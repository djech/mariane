...
// Returns the private 'App\Repository\WorkCategoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WorkCategoryRepository.php';

return $this->privates['App\Repository\WorkCategoryRepository'] = new \App\Repository\WorkCategoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
