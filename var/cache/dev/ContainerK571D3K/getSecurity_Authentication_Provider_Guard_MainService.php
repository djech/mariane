...
}, 1), ($this->privates['security.user.provider.concrete.fos_userbundle'] ?? $this->load('getSecurity_User_Provider_Concrete_FosUserbundleService.php')), 'main', ($this->privates['security.user_checker'] ?? $this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker()));
