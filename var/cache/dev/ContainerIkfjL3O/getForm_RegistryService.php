...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('FM\\ElfinderBundle\\Form\\Type\\ElFinderType' => function () {
    return ($this->privates['fm_elfinder.form.type'] ?? $this->privates['fm_elfinder.form.type'] = new \FM\ElfinderBundle\Form\Type\ElFinderType());
}, 'App\\Form\\AboutType' => function () {
    return ($this->privates['App\Form\AboutType'] ?? $this->privates['App\Form\AboutType'] = new \App\Form\AboutType());
}, 'App\\Form\\InformationLogicielsType' => function () {
    return ($this->privates['App\Form\InformationLogicielsType'] ?? $this->privates['App\Form\InformationLogicielsType'] = new \App\Form\InformationLogicielsType());
}, 'App\\Form\\InformationSkillsType' => function () {
    return ($this->privates['App\Form\InformationSkillsType'] ?? $this->privates['App\Form\InformationSkillsType'] = new \App\Form\InformationSkillsType());
}, 'App\\Form\\InformationType' => function () {
    return ($this->privates['App\Form\InformationType'] ?? $this->privates['App\Form\InformationType'] = new \App\Form\InformationType());
}, 'App\\Form\\LogicielType' => function () {
    return ($this->privates['App\Form\LogicielType'] ?? $this->privates['App\Form\LogicielType'] = new \App\Form\LogicielType());
}, 'App\\Form\\PortfolioType' => function () {
    return ($this->privates['App\Form\PortfolioType'] ?? $this->privates['App\Form\PortfolioType'] = new \App\Form\PortfolioType());
}, 'App\\Form\\SkillType' => function () {
    return ($this->privates['App\Form\SkillType'] ?? $this->privates['App\Form\SkillType'] = new \App\Form\SkillType());
}, 'App\\Form\\WorkType' => function () {
    return ($this->privates['App\Form\WorkType'] ?? $this->privates['App\Form\WorkType'] = new \App\Form\WorkType());
