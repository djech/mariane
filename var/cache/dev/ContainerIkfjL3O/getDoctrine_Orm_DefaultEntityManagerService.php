...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AboutRepository' => function () {
    return ($this->privates['App\Repository\AboutRepository'] ?? $this->load('getAboutRepositoryService.php'));
}, 'App\\Repository\\ExperienceRepository' => function () {
    return ($this->privates['App\Repository\ExperienceRepository'] ?? $this->load('getExperienceRepositoryService.php'));
}, 'App\\Repository\\FormationRepository' => function () {
    return ($this->privates['App\Repository\FormationRepository'] ?? $this->load('getFormationRepositoryService.php'));
}, 'App\\Repository\\InformationRepository' => function () {
    return ($this->privates['App\Repository\InformationRepository'] ?? $this->load('getInformationRepositoryService.php'));
}, 'App\\Repository\\LogicielRepository' => function () {
    return ($this->privates['App\Repository\LogicielRepository'] ?? $this->load('getLogicielRepositoryService.php'));
}, 'App\\Repository\\PortfolioRepository' => function () {
    return ($this->privates['App\Repository\PortfolioRepository'] ?? $this->load('getPortfolioRepositoryService.php'));
}, 'App\\Repository\\SkillRepository' => function () {
    return ($this->privates['App\Repository\SkillRepository'] ?? $this->load('getSkillRepositoryService.php'));
...
}, 'App\\Repository\\WorkCategoryRepository' => function () {
    return ($this->privates['App\Repository\WorkCategoryRepository'] ?? $this->load('getWorkCategoryRepositoryService.php'));
}, 'App\\Repository\\WorkRepository' => function () {
    return ($this->privates['App\Repository\WorkRepository'] ?? $this->load('getWorkRepositoryService.php'));
}))));
