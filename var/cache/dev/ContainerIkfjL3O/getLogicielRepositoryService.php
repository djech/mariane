...
// Returns the private 'App\Repository\LogicielRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LogicielRepository.php';

return $this->privates['App\Repository\LogicielRepository'] = new \App\Repository\LogicielRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
