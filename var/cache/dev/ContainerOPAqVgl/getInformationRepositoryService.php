...
// Returns the private 'App\Repository\InformationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InformationRepository.php';

return $this->privates['App\Repository\InformationRepository'] = new \App\Repository\InformationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
