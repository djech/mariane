...
// Returns the private 'App\Repository\WorkRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WorkRepository.php';

return $this->privates['App\Repository\WorkRepository'] = new \App\Repository\WorkRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
